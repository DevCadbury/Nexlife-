      ...
      >
        ...
        <div className="p-4 border-t border-[#E2E8F0]">
          ...
          <div className="mt-4 space-y-2">
            <a href="tel:+919664843790" className="flex items-center gap-2 text-sm text-slate-500 px-1">
              <Phone size={14} className="text-[#0A8A78]" />
              +91 96648 43790
            </a>
            <a href="tel:+918401546910" className="flex items-center gap-2 text-sm text-slate-500 px-1">
              <Phone size={14} className="text-[#0A8A78]" />
              +91 84015 46910
            </a>
            <a href="mailto:Info@nexlifeinternational.com" className="flex items-center gap-2 text-sm text-slate-500 px-1">
