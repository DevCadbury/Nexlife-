...
const StyledCardWrapper = styled.div`
  ...
  .card:hover {
    box-shadow: 0px 0px 30px 1px rgba(245, 158, 11, 0.3); /* Amber glow */
  }
  .card img {
    max-width: 100%;
    max-height: 100%;
...
const AntiSpasmodicProducts = () => {
  ...
  // Sample data for Anti-Spasmodic products
  const products = [
    {
      id: 1,
      ...
      description: "Antispasmodic medication for gastrointestinal spasms",
    },
    {
      id: 2,
      ...
      image: product2,
      category: "Anti-Spasmodic",
      description: "Antispasmodic for smooth muscle relaxation",
    },
    {
      id: 3,
      name: "Mebeverine HCl",
      ...
      image: product3,
      category: "Anti-Spasmodic",
      description: "Antispasmodic for irritable bowel syndrome",
    },
    {
      id: 4,
      name: "Papaverine HCl",
      ...
      image: product4,
      category: "Anti-Spasmodic",
      description: "Vasodilator and antispasmodic medication",
    },
  ];
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-300 mt-1">
                  Professional antispasmodic medications for smooth muscle
                  relaxation
                </p>
              </div>
            </div>
          ...
          <div className="flex flex-col lg:flex-row gap-4 items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              <select
                ...
                className="px-4 py-3 bg-white/10 border border-white/20 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent"
              >
