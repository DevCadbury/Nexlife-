...
// Import images
import dipranexImage from "../assets/images/anti-spasmodic/DIPRANEX-2-1.png";
import mefcyclonexImage from "../assets/images/anti-spasmodic/MEFCYCLONEX-2.png";
import rofafenexImage from "../assets/images/anti-spasmodic/ROTAFENEX.png";
...
const AntiSpasmodicProducts = () => {
  const [searchTerm, setSearchTerm] = useState("");

  // Anti Spasmodic products data
  const antiSpasmodicProducts = [
    {
      id: 1,
      name: "Mefenamic & Dicyclomine Hydrochloride Tablet",
      description:
        "Each Uncoated Tablet Contains: Mefenamic Acid BP____250mg Dicyclomine Hydrochloride BP____10mg Colour : Tartrazine",
    ...
    {
      id: 2,
      name: "Drotaverin & Mefenamic Acid Tablet",
      description:
        "Each Film Coated Tablet Contains: Drotaverine Hydrochloride____80mg Mefenamic Acid BP____250mg Colour : Erythrosine & Titanium Dioxide BP",
      type: "Film Coated Tablet",
      packaging: "Blister",
      image: mefcyclonexImage,
    },
    {
      id: 3,
      name: "Mefenamic Acid Dicyclomine Hydrochloride Tablet",
      description:
        "Each Uncoated Tablet Contains: Mefenamic Acid BP____500mg Dicyclomine Hydrochloride BP____20mg",
      type: "Uncoated Tablet",
      packaging: "Blister",
      image: rofafenexImage,
    },
    {
      id: 4,
      name: "Dicyclomine Hydrochloride & Paracetamol Tablet",
      description:
        "Each Uncoated Tablet Contains: Dicyclomine Hydrochloride BP____10mg Paracetamol BP____500mg",
      type: "Uncoated Tablet",
      packaging: "Blister",
      image: dipranexImage,
    },
  ...
  const searchResults = useMemo(() => {
    if (!searchTerm.trim()) return antiSpasmodicProducts;

    const searchLower = searchTerm.toLowerCase();
    return antiSpasmodicProducts.filter((product) => {
      return (
          ...
          >
            ...
            <div className="bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm rounded-2xl p-8 shadow-xl border border-white/20 dark:border-gray-700/20">
              <div className="flex items-center justify-center mb-6">
                <Link
                  to="/products"
                  className="inline-flex items-center space-x-2 text-amber-600 dark:text-amber-400 hover:text-amber-700 dark:hover:text-amber-300 font-medium transition-colors duration-200 mr-4"
                >
              ...
              <h1 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white mb-6">
                Anti Spasmodic Products
              </h1>
              <p className="text-xl text-gray-600 dark:text-gray-300 leading-relaxed">
                Explore our anti-spasmodic medications for effective relief of
                gastrointestinal and smooth muscle spasms.
              </p>
            </div>
          </motion.div>
        </div>
      ...
      <section className="section-padding bg-white dark:bg-gray-900">
        <div className="container-custom">
          ...
          >
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-12 py-3 border border-gray-300 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-amber-500 focus:border-transparent dark:bg-gray-800 dark:text-white transition-all duration-200"
              />
              {searchTerm && (
                <button
                ...
                >
                  ...
                  <div className="bg-gradient-to-r from-amber-500 to-amber-600 p-6 text-white">
                    <h2 className="text-2xl font-bold">
                      Anti Spasmodic Products Catalog
                    </h2>
                    <p className="text-amber-100 mt-2">
                      Complete list of our anti-spasmodic medications
                    </p>
                  </div>
                      ...
                      <tbody className="bg-white dark:bg-gray-800">
                        {displayProducts.map((product) => (
                          ...
                          >
                            ...
                            <td className="px-4 lg:px-6 py-3 lg:py-4 whitespace-nowrap border-r border-gray-300 dark:border-gray-600 last:border-r-0 hover:bg-amber-100 dark:hover:bg-amber-800/30 transition-colors duration-200">
                              <span className="text-xs font-medium bg-yellow-100 text-yellow-800 dark:bg-yellow-900 dark:text-yellow-200 px-2 py-1 rounded">
                                {product.packaging}
                              </span>
                            </td>
                          </motion.tr>
          ...
          >
            ...
            <div className="mt-3 h-1 w-24 bg-gradient-to-r from-amber-500 to-amber-600 mx-auto rounded-full"></div>
          </motion.div>
          ...
          >
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto justify-items-center">
              {antiSpasmodicProducts.slice(0, 3).map((product) => (
                <motion.div
                  key={product.id}
                  initial={{ opacity: 0, y: 20 }}
                  whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            <div className="bg-gradient-to-r from-amber-600 to-amber-700 rounded-2xl p-8 text-white">
              ...
              <p className="text-amber-100 mb-6">
                Get detailed information about all our anti-spasmodic products,
...
export default AntiSpasmodicProducts;
