...
const StyledCardWrapper = styled.div`
  ...
  .card:hover {
    box-shadow: 0px 0px 30px 1px rgba(239, 68, 68, 0.3); /* Red glow */
  }
  .card img {
    max-width: 100%;
    max-height: 100%;
...
const ErectileDysfunctionProducts = () => {
  ...
  // Sample data for Erectile Dysfunction products
  const products = [
    {
      id: 1,
      name: "Sildenafil",
      ...
      description: "PDE-5 inhibitor for erectile dysfunction treatment",
    },
    {
      id: 2,
      name: "Tadalafil",
      ...
      image: product2,
      category: "Erectile Dysfunction",
      description: "Long-acting PDE-5 inhibitor for ED treatment",
    },
    {
      id: 3,
      name: "Vardenafil",
      ...
      image: product3,
      category: "Erectile Dysfunction",
      description: "PDE-5 inhibitor with rapid onset of action",
    },
    {
      id: 4,
      name: "Avanafil",
      ...
      image: product4,
      category: "Erectile Dysfunction",
      description: "Fast-acting PDE-5 inhibitor for ED treatment",
    },
  ];
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-300 mt-1">
                  Professional medications for erectile dysfunction treatment
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col lg:flex-row gap-4 items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              <select
                ...
                className="px-4 py-3 bg-white/10 border border-white/20 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent"
              >
