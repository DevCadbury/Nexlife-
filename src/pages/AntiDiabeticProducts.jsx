...
const AntiDiabeticProducts = () => {
  ...
  const searchResults = useMemo(() => {
    if (!searchTerm.trim()) return antiDiabeticProducts;

    const searchLower = searchTerm.toLowerCase();
    return antiDiabeticProducts.filter((product) => {
      return (
          ...
          >
            ...
            <div className="bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm rounded-2xl p-8 shadow-xl border border-white/20 dark:border-gray-700/20">
              ...
              <p className="text-xl text-gray-600 dark:text-gray-300 leading-relaxed">
                Discover our comprehensive range of anti-diabetic medications
                for effective diabetes management and blood sugar control.
              </p>
            </div>
          </motion.div>
        </div>
                ...
                >
                  ...
                  <div className="bg-gradient-to-r from-purple-500 to-violet-600 p-6 text-white">
                    <h2 className="text-2xl font-bold">
                      Anti Diabetic Products Catalog
                    </h2>
                    <p className="text-purple-100 mt-2">
                      Complete list of our anti-diabetic medications
                    </p>
                  </div>
                    ...
                    <table className="w-full min-w-[900px] border-2 border-gray-300 dark:border-gray-600">
                      ...
                      <tbody className="bg-white dark:bg-gray-800">
                        {displayProducts.map((product, index) => (
                          ...
                          >
                            <td className="px-4 lg:px-6 py-3 lg:py-4 whitespace-nowrap border-r border-gray-300 dark:border-gray-600 last:border-r-0 hover:bg-purple-100 dark:hover:bg-purple-800/30 transition-colors duration-200">
                            ...
                            <td className="px-4 lg:px-6 py-3 lg:py-4 border-r border-gray-300 dark:border-gray-600 last:border-r-0 hover:bg-purple-100 dark:hover:bg-purple-800/30 transition-colors duration-200">
                            ...
                            <td className="px-4 lg:px-6 py-3 lg:py-4 whitespace-nowrap border-r border-gray-300 dark:border-gray-600 last:border-r-0 hover:bg-purple-100 dark:hover:bg-purple-800/30 transition-colors duration-200">
                              <span className="text-xs font-medium bg-violet-100 text-violet-800 dark:bg-violet-900 dark:text-violet-200 px-2 py-1 rounded">
                                {product.packaging}
                              </span>
                            </td>
                          </motion.tr>
...
export default AntiDiabeticProducts;
