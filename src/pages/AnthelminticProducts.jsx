...
import albendazoleImage from "../assets/images/anthelmintic/ALBENDAZOLE-ANTHELMINITIC.png";
import albendazoleImage2 from "../assets/images/anthelmintic/ALBENDAZOLE-ANTHELMINITIC5.png";
...
const AnthelminticProducts = () => {
  const [searchTerm, setSearchTerm] = useState("");

  // Anthelmintic products data with images
  const anthelminticProducts = [
    {
      id: 1,
      name: "Albendazole & Ivermectin Tablet",
      description:
        "Each Uncoated Tablet Contains: Albendazole BP___ 400mg Ivermectin BP___12mg",
    ...
    },
    {
      ...
      description:
        "Each Chewable Tablet Contains : Albendazole BP___400mg Colour : Sunset Yellow FCF",
  ...
  const searchResults = useMemo(() => {
    if (!searchTerm.trim()) return anthelminticProducts;

    const searchLower = searchTerm.toLowerCase();
    return anthelminticProducts.filter((product) => {
      return (
          ...
          >
            ...
            <div className="bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm rounded-2xl p-8 shadow-xl border border-white/20 dark:border-gray-700/20">
              ...
              <p className="text-xl text-gray-600 dark:text-gray-300 leading-relaxed">
                Discover our comprehensive range of anthelmintic medications for
                parasitic worm treatment and prevention.
              </p>
            </div>
          </motion.div>
        </div>
      ...
      <section className="section-padding bg-white dark:bg-gray-900">
        <div className="container-custom">
                ...
                >
                  ...
                  <div className="bg-gradient-to-r from-green-500 to-emerald-600 p-6 text-white">
                    <h2 className="text-2xl font-bold">
                      Anthelmintic Products Catalog
                    </h2>
                    <p className="text-green-100 mt-2">
                      Complete list of our anthelmintic medications
                    </p>
                  </div>
                      ...
                      <tbody className="bg-white dark:bg-gray-800">
                        {displayProducts.map((product, index) => (
                          <motion.tr
                            key={product.id}
                            variants={itemVariants}
                            className="hover:bg-green-50 dark:hover:bg-green-900/20 transition-all duration-300 border-b border-gray-300 dark:border-gray-600 last:border-b-0"
                          >
                            <td className="px-4 lg:px-6 py-3 lg:py-4 whitespace-nowrap border-r border-gray-300 dark:border-gray-600 last:border-r-0 hover:bg-green-100 dark:hover:bg-green-800/30 transition-colors duration-200">
                            ...
                            <td className="px-4 lg:px-6 py-3 lg:py-4 border-r border-gray-300 dark:border-gray-600 last:border-r-0 hover:bg-green-100 dark:hover:bg-green-800/30 transition-colors duration-200">
                            ...
                            <td className="px-4 lg:px-6 py-3 lg:py-4 whitespace-nowrap border-r border-gray-300 dark:border-gray-600 last:border-r-0 hover:bg-green-100 dark:hover:bg-green-800/30 transition-colors duration-200">
                              <span className="text-xs font-medium bg-emerald-100 text-emerald-800 dark:bg-emerald-900 dark:text-emerald-200 px-2 py-1 rounded">
                                {product.packaging}
                              </span>
                            </td>
                          </motion.tr>
          ...
          >
            ...
            <div className="mt-3 h-1 w-24 bg-gradient-to-r from-green-500 to-emerald-600 mx-auto rounded-full"></div>
          </motion.div>
          ...
          >
            <div className="bg-gradient-to-r from-green-600 to-emerald-600 rounded-2xl p-8 text-white">
              ...
              <p className="text-green-100 mb-6">
                Get detailed information about all our anthelmintic products,
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-flex items-center space-x-3 bg-white text-green-600 px-6 py-3 rounded-xl font-semibold hover:bg-gray-100 transition-all duration-200 shadow-lg hover:shadow-xl"
              >
...
export default AnthelminticProducts;
