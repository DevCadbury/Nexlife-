...
const Home = () => {
  ...
  return (
    <div className="min-h-screen">
      ...
      >
        {/* Overlay for light/dark theme support */}
        <div className="absolute inset-0 bg-gradient-to-br from-blue-50/30 via-white/25 to-blue-100/30 dark:from-gray-900/40 dark:via-gray-800/35 dark:to-gray-900/40"></div>

        <div className="container-custom relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            {/* Left Side - Text Content with Glass Effect */}
            <div className="text-left relative rounded-3xl p-8 md:p-10 shadow-2xl overflow-hidden" style={{ isolation: 'isolate', willChange: 'auto' }}>
              {/* Stable semi-transparent background - no backdrop effects */}
              <div className="absolute inset-0 bg-white dark:bg-gray-900" style={{ opacity: 0.85 }}></div>
              <div className="absolute inset-0 border border-white/50 dark:border-gray-700/50 rounded-3xl pointer-events-none"></div>
      ...
      <section className="section-padding bg-gradient-to-br from-blue-50 to-white dark:from-gray-800 dark:to-gray-900 relative" style={{ overflow: 'visible', zIndex: 10, transform: 'translateZ(0)' }}>
        ...
        <div className="container-custom relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 relative" style={{ zIndex: 50, transform: 'translateZ(0)', isolation: 'isolate' }}>
            ...
            <motion.div
              ...
              whileHover={{ y: -5, scale: 1.01, rotateY: -3 }}
              style={{ position: 'relative', zIndex: 100, willChange: 'transform' }}
      ...
      <section className="section-padding bg-white dark:bg-gray-900 relative overflow-visible">
        <div className="container-custom relative z-10">
          <motion.div
      ...
      <section className="section-padding bg-gradient-to-r from-gray-50 to-blue-50 dark:from-gray-800 dark:to-gray-900 relative overflow-visible">
        <div className="container-custom relative z-10">
          <motion.div
            variants={containerVariants}
            initial="hidden"
      ...
      <section className="section-padding bg-gradient-to-br from-gray-50 to-blue-50 dark:from-gray-800 dark:to-gray-900 relative overflow-visible">
        <div className="container-custom relative z-10">
          <motion.div
            variants={containerVariants}
            initial="hidden"
      ...
      <section className="py-20 bg-gradient-to-br from-gray-50 to-blue-50 dark:from-gray-800 dark:to-gray-900 relative overflow-visible">
        <div className="container-custom relative z-10">
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
      ...
      <section className="section-padding bg-gradient-to-r from-primary-500 to-secondary-500 relative overflow-visible">
