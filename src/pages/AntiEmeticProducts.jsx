...
const StyledCardWrapper = styled.div`
  ...
  .card:hover {
    box-shadow: 0px 0px 30px 1px rgba(236, 72, 153, 0.3); /* Pink glow */
  }
  .card img {
    max-width: 100%;
    max-height: 100%;
...
const AntiEmeticProducts = () => {
  ...
  // Sample data for Anti-Emetic products
  const products = [
    {
      id: 1,
      name: "Ondansetron",
      ...
      description: "Antiemetic for nausea and vomiting prevention",
    },
    {
      id: 2,
      name: "Metoclopramide",
      ...
      image: product2,
      category: "Anti-Emetic",
      description: "Prokinetic antiemetic medication",
    },
    {
      id: 3,
      name: "Domperidone",
      ...
      image: product3,
      category: "Anti-Emetic",
      description: "Dopamine antagonist antiemetic",
    },
    {
      id: 4,
      name: "Promethazine",
      ...
      image: product4,
      category: "Anti-Emetic",
      description: "Antihistamine with antiemetic properties",
    },
  ];
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-300 mt-1">
                  Professional antiemetic medications for nausea and vomiting
                  control
                </p>
              </div>
            </div>
          ...
          <div className="flex flex-col lg:flex-row gap-4 items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              <select
                ...
                className="px-4 py-3 bg-white/10 border border-white/20 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-pink-500 focus:border-transparent"
              >
