...
const DrySyrupsProducts = () => {
  const [searchTerm, setSearchTerm] = useState("");

  // Dry Syrups products data
  const drySyrupsProducts = [
    {
      id: 1,
      name: "Azithromycin Dry Syrup",
      description: "Azithromycin dihydrate USP",
      strength: "100mg/5ml",
      packing: "HDPE Bottle",
      image: product1,
    },
    ...
    },
    {
      ...
      description: "Erythromycin Estolate BP",
      strength: "125mg/5ml",
      packing: "HDPE Bottle",
      image: product5,
    },
  ...
  const searchResults = useMemo(() => {
    if (!searchTerm.trim()) return drySyrupsProducts;

    const searchLower = searchTerm.toLowerCase();
    return drySyrupsProducts.filter((product) => {
      return (
  ...
  const displayProducts = searchTerm.trim() ? searchResults : drySyrupsProducts;
          ...
          >
            ...
            <div className="bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm rounded-2xl p-8 shadow-xl border border-white/20 dark:border-gray-700/20">
              ...
              <p className="text-xl text-gray-600 dark:text-gray-300 leading-relaxed">
                Professional dry syrup formulations for pediatric and adult use
                with precise dosing and excellent stability.
              </p>
            </div>
          </motion.div>
        </div>
            ...
            {hasSearchResults ? (
              ...
              >
                ...
                <motion.div
                  ...
                  className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl border-2 border-cyan-200 dark:border-cyan-600 overflow-hidden"
                >
                  {/* Table Header */}
                  <div className="bg-gradient-to-r from-cyan-500 to-blue-600 p-6 text-white">
                    <h2 className="text-2xl font-bold">
                      Dry Syrups Products Catalog
                    </h2>
                    <p className="text-cyan-100 mt-2">
                      Complete list of our dry syrup formulations
                    </p>
                  </div>
                      ...
                      <tbody className="bg-white dark:bg-gray-800">
                        {displayProducts.map((product, index) => (
                          <motion.tr
                            key={product.id}
                            variants={itemVariants}
                            className="hover:bg-cyan-50 dark:hover:bg-cyan-900/20 transition-all duration-300 border-b border-gray-300 dark:border-gray-600 last:border-b-0"
                          >
                            <td className="px-4 lg:px-6 py-3 lg:py-4 whitespace-nowrap border-r border-gray-300 dark:border-gray-600 last:border-r-0 hover:bg-cyan-100 dark:hover:bg-cyan-800/30 transition-colors duration-200">
                            ...
                            <td className="px-4 lg:px-6 py-3 lg:py-4 border-r border-gray-300 dark:border-gray-600 last:border-r-0 hover:bg-cyan-100 dark:hover:bg-cyan-800/30 transition-colors duration-200">
              ...
              >
                ...
                <button
                  onClick={() => setSearchTerm("")}
                  className="inline-flex items-center space-x-2 text-cyan-600 dark:text-cyan-400 hover:text-cyan-700 dark:hover:text-cyan-300 font-medium transition-colors duration-200"
                >
          ...
          >
            <div className="bg-gradient-to-r from-cyan-600 to-blue-600 rounded-2xl p-8 text-white">
              ...
              <p className="text-cyan-100 mb-6">
                Get detailed information about all our dry syrup products,
...
export default DrySyrupsProducts;
