...
const AntiMalarialProducts = () => {
  ...
  const searchResults = useMemo(() => {
    if (!searchTerm.trim()) return antiMalarialProducts;

    const searchLower = searchTerm.toLowerCase();
    return antiMalarialProducts.filter((product) => {
      return (
          ...
          >
            ...
            <div className="bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm rounded-2xl p-8 shadow-xl border border-white/20 dark:border-gray-700/20">
              ...
              <p className="text-xl text-gray-600 dark:text-gray-300 leading-relaxed">
                Discover our comprehensive range of anti-malarial medications
                for effective malaria prevention and treatment.
              </p>
            </div>
          </motion.div>
        </div>
                ...
                >
                  ...
                  <div className="bg-gradient-to-r from-red-500 to-red-600 p-6 text-white">
                    <h2 className="text-2xl font-bold">
                      Anti Malarial Products Catalog
                    </h2>
                    <p className="text-red-100 mt-2">
                      Complete list of our anti-malarial medications
                    </p>
                  </div>
...
export default AntiMalarialProducts;
