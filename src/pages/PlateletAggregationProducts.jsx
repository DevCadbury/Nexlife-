...
const StyledCardWrapper = styled.div`
  ...
  .card:hover {
    box-shadow: 0px 0px 30px 1px rgba(132, 204, 22, 0.3); /* Lime glow */
  }
  .card img {
    max-width: 100%;
    max-height: 100%;
...
const PlateletAggregationProducts = () => {
  ...
  // Sample data for Platelet Aggregation products
  const products = [
    {
      id: 1,
      name: "Aspirin",
    ...
    },
    {
      ...
      image: product2,
      category: "Platelet Aggregation",
      description: "P2Y12 receptor antagonist for platelet inhibition",
    },
    {
      id: 3,
      name: "Ticagrelor",
      ...
      image: product3,
      category: "Platelet Aggregation",
      description: "Reversible P2Y12 receptor antagonist",
    },
    {
      id: 4,
      name: "Prasugrel",
      ...
      image: product4,
      category: "Platelet Aggregation",
      description: "Thienopyridine antiplatelet agent",
    },
  ];
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-300 mt-1">
                  Professional antiplatelet medications for cardiovascular
                  protection
                </p>
              </div>
            </div>
          ...
          <div className="flex flex-col lg:flex-row gap-4 items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              <select
                ...
                className="px-4 py-3 bg-white/10 border border-white/20 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-lime-500 focus:border-transparent"
              >
