        ...
        <div className="container-custom">
          ...
          >
            <div className="bg-gradient-to-r from-emerald-600 to-green-600 rounded-2xl p-8 text-white">
              ...
              <button className="inline-flex items-center space-x-3 bg-white text-emerald-600 px-6 py-3 rounded-xl font-semibold hover:bg-gray-100 transition-all duration-200 shadow-lg hover:shadow-xl">
