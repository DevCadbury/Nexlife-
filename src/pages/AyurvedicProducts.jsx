...
const AyurvedicProducts = () => {
  ...
  // Ayurvedic products data
  const ayurvedicProducts = [
    {
      id: 1,
      name: "MEDIMOVE Pain Relief Gel",
      description: "Ayurvedic Pain Relief Gel",
      packing: "30g",
      image: product6,
    },
    {
    ...
    },
    {
      ...
      description: "Ayurvedic Itch Care Cream",
      packing: "25g",
      image: product8,
    },
    {
      id: 4,
      name: "HAIR CARE Oil",
      description: "Almond, Jasmine, Amla, Coconut Oil",
    ...
    },
    {
      id: 5,
      name: "TURMERIC CREAM",
      description: "Turmeric Skin Cream",
      packing: "30g",
      image: product1,
    },
  ];
          ...
          >
            ...
            <div className="bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm rounded-2xl p-8 shadow-xl border border-white/20 dark:border-gray-700/20">
              ...
              <p className="text-xl text-gray-600 dark:text-gray-300 leading-relaxed">
                Traditional Ayurvedic formulations for natural healing and
                wellness.
              </p>
            </div>
          </motion.div>
      ...
      <section className="section-padding bg-white dark:bg-gray-900">
        <div className="container-custom">
            ...
            {hasSearchResults ? (
              ...
              >
                ...
                <motion.div
                  ...
                  className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl border-2 border-emerald-200 dark:border-emerald-600 overflow-hidden"
                >
                  {/* Table Header */}
                  <div className="bg-gradient-to-r from-emerald-500 to-green-600 p-6 text-white">
                    ...
                    <p className="text-emerald-100 mt-2">
                      Complete list of our Ayurvedic formulations
                    </p>
                  </div>
                      ...
                      <tbody className="bg-white dark:bg-gray-800">
                        {displayProducts.map((product, index) => (
                          <motion.tr
                            key={product.id}
                            variants={itemVariants}
                            className="hover:bg-emerald-50 dark:hover:bg-emerald-900/20 transition-all duration-300 border-b border-gray-300 dark:border-gray-600 last:border-b-0"
                          >
                            <td className="px-4 lg:px-6 py-3 lg:py-4 whitespace-nowrap border-r border-gray-300 dark:border-gray-600 last:border-r-0 hover:bg-emerald-100 dark:hover:bg-emerald-800/30 transition-colors duration-200">
                            ...
                            <td className="px-4 lg:px-6 py-3 lg:py-4 border-r border-gray-300 dark:border-gray-600 last:border-r-0 hover:bg-emerald-100 dark:hover:bg-emerald-800/30 transition-colors duration-200">
              ...
              >
                ...
                <button
                  onClick={() => setSearchTerm("")}
                  className="inline-flex items-center space-x-2 text-emerald-600 dark:text-emerald-400 hover:text-emerald-700 dark:hover:text-emerald-300 font-medium transition-colors duration-200"
                >
          ...
          >
            ...
            <div className="mt-3 h-1 w-24 bg-gradient-to-r from-emerald-500 to-green-600 mx-auto rounded-full"></div>
          </motion.div>
          ...
          >
            <div className="bg-gradient-to-r from-emerald-600 to-green-600 rounded-2xl p-8 text-white">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-flex items-center space-x-3 bg-white text-emerald-600 px-6 py-3 rounded-xl font-semibold hover:bg-gray-100 transition-all duration-200 shadow-lg hover:shadow-xl"
              >
