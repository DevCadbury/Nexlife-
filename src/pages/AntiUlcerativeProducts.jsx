...
const StyledCardWrapper = styled.div`
  ...
  .card:hover {
    box-shadow: 0px 0px 30px 1px rgba(16, 185, 129, 0.3); /* Emerald glow */
  }
  .card img {
    max-width: 100%;
    max-height: 100%;
...
const AntiUlcerativeProducts = () => {
  ...
  // Sample data for Anti-Ulcerative products
  const products = [
    {
      id: 1,
      name: "Omeprazole",
      ...
      description: "Proton pump inhibitor for gastric ulcer treatment",
    },
    {
      id: 2,
      name: "Ranitidine",
      ...
      image: product2,
      category: "Anti-Ulcerative",
      description: "H2 receptor antagonist for ulcer prevention",
    },
    {
      id: 3,
      name: "Sucralfate",
      ...
      image: product3,
      category: "Anti-Ulcerative",
      description: "Cytoprotective agent for gastric ulcers",
    },
    {
      id: 4,
      name: "Misoprostol",
      ...
      image: product4,
      category: "Anti-Ulcerative",
      description: "Prostaglandin analogue for ulcer prevention",
    },
  ];
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-300 mt-1">
                  Professional anti-ulcerative medications for gastric
                  protection
                </p>
              </div>
            </div>
          ...
          <div className="flex flex-col lg:flex-row gap-4 items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              <select
                ...
                className="px-4 py-3 bg-white/10 border border-white/20 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent"
              >
