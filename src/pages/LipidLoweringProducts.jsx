...
const StyledCardWrapper = styled.div`
  ...
  .card:hover {
    box-shadow: 0px 0px 30px 1px rgba(249, 115, 22, 0.3); /* Orange glow */
  }
  .card img {
    max-width: 100%;
    max-height: 100%;
...
const LipidLoweringProducts = () => {
  ...
  // Sample data for Lipid Lowering products
  const products = [
    {
      id: 1,
      name: "Atorvastatin",
    ...
    },
    {
      ...
      image: product2,
      category: "Lipid Lowering",
      description: "Statins for lowering LDL cholesterol levels",
    },
    {
      id: 3,
      name: "Rosuvastatin",
      ...
      image: product3,
      category: "Lipid Lowering",
      description: "High-potency statin for lipid management",
    },
    {
      id: 4,
      name: "Fenofibrate",
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-300 mt-1">
                  Professional medications for cholesterol and lipid management
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col lg:flex-row gap-4 items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              <select
                ...
                className="px-4 py-3 bg-white/10 border border-white/20 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent"
              >
