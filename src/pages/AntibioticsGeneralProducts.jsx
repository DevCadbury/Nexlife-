...
const StyledCardWrapper = styled.div`
  ...
  .card:hover {
    box-shadow: 0px 0px 30px 1px rgba(6, 182, 212, 0.3); /* Cyan glow */
  }
  .card img {
    max-width: 100%;
    max-height: 100%;
...
const AntibioticsGeneralProducts = () => {
  ...
  // Sample data for General Antibiotics products
  const products = [
    {
      id: 1,
      name: "Amoxicillin",
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-3xl font-bold text-white">
                  General Antibiotics Products
                </h1>
                <p className="text-gray-300 mt-1">
                  Professional antibiotic medications for bacterial infections
                </p>
              </div>
            </div>
          </div>
