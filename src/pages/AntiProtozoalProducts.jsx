...
const AntiProtozoalProducts = () => {
  ...
  const searchResults = useMemo(() => {
    if (!searchTerm.trim()) return antiProtozoalProducts;

    const searchLower = searchTerm.toLowerCase();
    return antiProtozoalProducts.filter((product) => {
      return (
          ...
          >
            ...
            <div className="bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm rounded-2xl p-8 shadow-xl border border-white/20 dark:border-gray-700/20">
              ...
              <p className="text-xl text-gray-600 dark:text-gray-300 leading-relaxed">
                Discover our comprehensive range of anti-protozoal medications
                for effective treatment of protozoal infections.
              </p>
            </div>
          </motion.div>
        </div>
                ...
                >
                  ...
                  <div className="bg-gradient-to-r from-cyan-500 to-blue-600 p-6 text-white">
                    <h2 className="text-2xl font-bold">
                      Anti Protozoal Products Catalog
                    </h2>
                    <p className="text-cyan-100 mt-2">
                      Complete list of our anti-protozoal medications
                    </p>
                  </div>
...
export default AntiProtozoalProducts;
